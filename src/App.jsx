...
function App() {
  return (
    <>
      <Navbar />
      <main className="px-10  bg-gradient-to-b from-[#0B002B] to-[#1A0255] ">
        <div className="max-w-[1300px] mx-auto relative h-full py-24">
          <div
            style={{
              background: "#DF5B5B",
              borderRadius: 16,
          ...
          <img
            ...
            className="absolute top-32 left-[33px]"
          />
        </div>
      </main>
    </>
